...
class AppUserController {
	...
	static def navStates = [new NavigationUI(name:'Manage Users',messageCode:"nav.ManageUsers")]
	static def reports = []
	static def primaryFields=['username','dateCreated','lastUpdated','enabled','accountExpired','accountLocked','passwordExpired']
